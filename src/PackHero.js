...
class PackHero extends React.Component {
    constructor(props) {
        super(props);
                ...
                <SectionContainer>
                    <SectionContainerExtension>
                        ...
                        <Row style={{backgroundImage: `url(${BGTab})`}}>
                            <Col xs={3} sm={3} md={3}><div id="hero" onClick={() => window.location.replace("/packageHero")} style={{cursor: 'pointer'}}><img style={{width: '90%'}} src={require('./asset/pack/packall/buttHero.png')}></img></div></Col>
