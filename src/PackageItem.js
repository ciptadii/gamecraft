        ...
        if (/Mobi|Android/i.test(navigator.userAgent)) {
            return (<>
                <Row style={{backgroundImage: `url(${BGTab})`}}>
                    ...
                    <Col xs={3} sm={3} md={3}><a href="/packageItem"><img width={'80%'} src={require('./asset/pack/packall/buttItem.png')}></img></a></Col>
                </Row>
            ...
            <Row style={{backgroundImage: `url(${BGTab})`}}>
                ...
                <Col sm={3} md={3}><a href="/packageItem"><img src={require('./asset/pack/packall/buttItem.png')}></img></a></Col>
            </Row>
