...
class PackEquipment extends React.Component {
    constructor(props) {
        super(props);
                ...
                <SectionContainer>
                    <SectionContainerExtension>
                        ...
                        <Row style={{backgroundImage: `url(${BGTab})`}}>
                            ...
                            <Col xs={3} sm={3} md={3}><div id="upgrade" onClick={() => window.location.replace("/packageEquipment")} style={{cursor: 'pointer'}}><img style={{width: '90%'}} src={require('./asset/Home/Button Equipment.png')}></img></div></Col>
                            ...
                            <Col xs={3} sm={3} md={3}><div id="all" onClick={() => window.location.replace("/packageSpecial")} style={{cursor: 'pointer', opacity: '0.4'}}><h1 id="allText" style={{position: 'absolute'}}></h1><img style={{width: '90%'}} src={require('./asset/Home/Button [ 2 ] Special.png')}></img></div></Col>
                        </Row>
