...
class PackageUpgrade extends React.Component {
    constructor(props) {
        super(props);
        ...
        if (/Mobi|Android/i.test(navigator.userAgent)) {
            return (<>
                <Row style={{backgroundImage: `url(${BGTab})`}}>
                    ...
                    <Col xs={3} sm={3} md={3} style={{opacity: 0.4}}><a href="/packageHero"><img width={'80%'} src={require('./asset/pack/packall/buttHero.png')}></img></a></Col>
                    <Col xs={3} sm={3} md={3}><a href="/packageUpgrade"><img width={'80%'} src={require('./asset/pack/packall/buttUp.png')}></img></a></Col>
            ...
            <Row style={{backgroundImage: `url(${BGTab})`}}>
                ...
                <Col sm={3} md={3} style={{opacity: 0.4}}><a href="/packageHero"><img src={require('./asset/pack/packall/buttHero.png')}></img></a></Col>
                <Col sm={3} md={3}><a href="/packageUpgrade"><img src={require('./asset/pack/packall/buttUp.png')}></img></a></Col>
